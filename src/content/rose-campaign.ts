      ...
      strategies: [
        {
          ...
          success: { stamp: "THE CORNER STAYS HOME", headline: "Miami's trap breaks before Rose does", detail: "Korver's first three forces Wade to stay attached. Rose reaches the paint with one defender, and the entire geometry of the rematch changes.", effects: [resource("competitive-power", 9, "Competitive power"), relationship("rose-trust", 7, "Derrick Rose trust"), resource("team-cohesion", 5, "Team cohesion"), ...title2012.effects] },
        ...
        },
        {
          ...
          success: { stamp: "THE SECOND ENGINE", headline: "Noah turns Miami's pressure into Chicago's advantage", detail: "Every trap gives Noah a runway and Rose a moving defense. The Bulls stop asking one player to solve five defenders.", effects: [resource("competitive-power", 10, "Competitive power"), relationship("rose-trust", 6, "Derrick Rose trust"), relationship("thibs-trust", 5, "Tom Thibodeau trust"), resource("team-cohesion", 7, "Team cohesion"), ...title2012.effects] },
    ...
    },
    {
      ...
      strategies: [
        ...
        },
        {
          ...
          success: { stamp: "OLD ANSWER, NEW NIGHT", headline: "Noah finds Rose before Cleveland can load the lane", detail: "The pass arrives between switches. Rose finishes, Chicago takes a 3–1 lead, and the offense proves its oldest adjustment still travels.", effects: [resource("competitive-power", 8, "Competitive power"), relationship("thibs-trust", 8, "Tom Thibodeau trust"), resource("team-cohesion", 6, "Team cohesion"), ...title2015.effects] },
        ...
        },
        {
          ...
          success: { stamp: "THE VETERAN SEES IT", headline: "Gasol finds Butler on the cut and Cleveland loses the map", detail: "The pass travels through the exact space Rose's gravity opens. Chicago's veteran addition and emerging wing finish the MVP's possession together.", effects: [resource("competitive-power", 10, "Competitive power"), relationship("butler-trust", 8, "Jimmy Butler trust"), relationship("rose-trust", 5, "Derrick Rose trust"), resource("team-cohesion", 7, "Team cohesion"), ...title2015.effects] },

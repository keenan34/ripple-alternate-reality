  ...
  turns: [
    ...
    },
    {
      ...
      strategies: [
        ...
        {
          id: "chase-banner-two", title: "Run it back for a second banner", summary: "Re-sign Paul, hand the difference-maker you found on the wire a real role, and go win the title the gap year cost you — one more June, one more banner, no dynasty talk required.", approach: "Second-title push / Depth payoff", baseChance: 74, costs: { "cap-flexibility": 9 }, requirements: [{ scope: "flag", key: "free-agent-signed", operator: "equals", value: true }, { scope: "flag", key: "championships", operator: "equals", value: 1 }],
          success: { stamp: "BANNER TWO SECURED", headline: "The roster you assembled wins the 2014 title", detail: "Paul signs, the wire addition swings the rotation you were missing, and Los Angeles hangs a second banner of the era. Not a three-peat — the gap year saw to that — but a title nobody can argue was luck.", effects: [flag("cp3-extended", true, "Paul signs long-term"), banner("title-2014", "2014 NBA CHAMPIONS"), resource("competitive-power", 8, "Competitive power"), relationship("cp3-trust", 6, "Chris Paul trust"), relationship("kobe-trust", 5, "Kobe Bryant trust")] },
          failure: { stamp: "ONE JUNE SHORT", headline: "The band runs it back and comes up a round short", detail: "Paul re-signs and the depth is real, but the miles finally show in May. A proud, expensive team walks off the floor knowing the second banner stayed just out of reach.", effects: [flag("cp3-extended", true, "Paul signs long-term"), resource("competitive-power", 3, "Competitive power"), resource("cap-flexibility", -6, "Cap flexibility"), relationship("cp3-trust", 4, "Chris Paul trust")] },
        },
        {
